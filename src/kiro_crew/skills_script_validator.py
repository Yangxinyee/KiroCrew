...
oversized files, non-Python scripts, and syntax errors. A script that fails
here is dropped and never reaches disk; its candidate proceeds with whatever
scripts survive, prose-only when none do; the advisory Haiku review is a
separate, softer signal layered on top of this hard gate.
"""
