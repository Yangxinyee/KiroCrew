...
# admits it, which is exactly the gap #8781 reports for the name field.
_CRED_NAME = "AKIAIOSFODNN7EXAMPLE"
_BENIGN_VALUE = "Reviews pull requests and summarizes diffs."


class TestRosterFreeTextMasking:
    """GET /api/members masks agent-record free text (#8781, #8717's rule).
    ...
    async def test_every_untrusted_text_field_in_the_row_is_guarded(self, tmp_path):
        ...
        shipping unmasked (the structural gap that let ``description`` and
        ``triggers`` slip past #8781's first cut).
        """
