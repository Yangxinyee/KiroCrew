          ...
          <div style={{ minWidth: 0, display: 'flex', alignItems: 'baseline', gap: 6, whiteSpace: 'nowrap', overflow: 'hidden' } as CSSProperties}>
            ...
            {channelFor(w) ? (
              <Badge
                ...
                title={i18nT('pages.devFleetPage.release_channel_pinned_at', { lane: channelFor(w)!.lane, ref: channelFor(w)!.ref || '?' })}
              >
                {channelFor(w)!.version || channelFor(w)!.ref || channelFor(w)!.lane}
              </Badge>
            ) : null}
